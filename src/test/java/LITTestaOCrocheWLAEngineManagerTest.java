...
public class LITTestaOCrocheWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(LITTestaOCrocheWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/LITTestaOCrocheWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/LITTestaOCrocheWLAIW/InitOutcome.xml").getDocumentElement();
